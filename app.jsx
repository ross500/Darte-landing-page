    ...
    <section className="sec-pad sec-light">
      <div className="wrap" style={{ textAlign: 'center' }}>
        ...
        <p className="reveal" style={{ font: '500 clamp(19px,2.4vw,28px)/1.45 var(--font-body)', color: '#26332b', maxWidth: 820, margin: '20px auto 0', textWrap: 'balance' }}>
          ...
          <span style={{ color: '#0c8f00', fontWeight: 700 }}> one intelligent, seamless planning experience.</span>
        </p>
  ...
  return (
    <section className="sec-pad" style={{ background: 'var(--bg-sunken)' }}>
      <div className="wrap">
        ...
        <p className="reveal" style={{ textAlign: 'center', font: '700 clamp(24px,3.6vw,40px)/1.35 var(--font-body)', margin: '36px auto 0', maxWidth: 760, textWrap: 'balance' }}>
          <span style={{ color: 'var(--text-strong)' }}>DARTE does not replace existing platforms.</span> <span style={{ color: 'var(--cat-reservations)' }}>It connects them.</span>
        </p>
      </div>
    </section>
  );
